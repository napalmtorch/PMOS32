...
;        CallInterrupt16() resets all selectors.
;
; C Prototype:
;   void _cdelc CallInterrupt16(unsigned char intnum, Registers16 *regs);
; 
; Example of usage:
;   regs.ax = 0x0013;
...
%define STACK16                                (INT32_BASE - Registers16_size)
 
 
section .text
    CallInterrupt16: use32                               ; by Napalm
    _int32:
    ...
    reloc: use32                               ; by Napalm
        ...
        mov  ecx, Registers16_size                ; set copy size to our struct size
